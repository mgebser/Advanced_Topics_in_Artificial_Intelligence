...
# COMMANDS TO RUN:
# python control.revised.py instance_04.lp events_04.lp elevator.lp
# python control.revised.py instance_04.lp events_04.lp elevator.lp --stats
...
### DO SOMETHING LIKE THIS BEFORE THE WHILE LOOP TO PERFORM MULTI-SHOT SOLVING
    ctl = clingo.Control(arguments = ["--opt-strategy", "usc", "--warn", "none", "--conf", "crafty"])
